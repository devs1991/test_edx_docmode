...
class OrganizationSliderAdmin(admin.ModelAdmin):
    ...
    Admin for the CourseOrganization table.
    """
    list_display = ('image', 'organization', 'active')
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        return super(OrganizationSliderAdmin, self).formfield_for_foreignkey(db_field, request, **kwargs)



admin.site.register(Organization, OrganizationAdmin)
admin.site.register(OrganizationCourse, OrganizationCourseAdmin)
admin.site.register(OrganizationSlider, OrganizationSliderAdmin)