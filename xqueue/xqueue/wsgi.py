...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "xqueue.aws_settings")
os.environ.setdefault("SERVICE_VARIANT", "xqueue")
os.chdir('/home/docmode/edx-20160414-2/apps/edx/edx-platform/xqueue')
